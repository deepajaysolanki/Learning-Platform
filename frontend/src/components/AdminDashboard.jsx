...
export default function AdminDashboard() {
  ...
  const fetchAdminOverview = async () => {
    try {
      const res = await fetch("https://vibestudy-backend-avmi.onrender.com/admin/stats", {
  ...
  const fetchModelStats = async () => {
    try {
      const res = await fetch("https://vibestudy-backend-avmi.onrender.com/admin/model-stats", {
        headers: { Authorization: `Bearer ${token}` },
      });
      const data = await res.json();
      setModelStats(data);
  ...
  const fetchUsers = async () => {
    try {
      const res = await fetch("https://vibestudy-backend-avmi.onrender.com/admin/users", {
        headers: { Authorization: `Bearer ${token}` },
      });
      const data = await res.json();
      setUsers(data.users || []);
  ...
  const fetchNotebooks = async () => {
    try {
      const res = await fetch("https://vibestudy-backend-avmi.onrender.com/admin/notebooks", {
        headers: { Authorization: `Bearer ${token}` },
      });
      const data = await res.json();
  ...
  const fetchMessages = async () => {
    try {
      const res = await fetch("https://vibestudy-backend-avmi.onrender.com/admin/messages", {
        headers: { Authorization: `Bearer ${token}` },
      });
      const data = await res.json();
  ...
  const handleDeleteUser = async (id) => {
    ...
    const res = await fetch(`https://vibestudy-backend-avmi.onrender.com/admin/user/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const handleDeleteNotebook = async (id) => {
    ...
    const res = await fetch(`https://vibestudy-backend-avmi.onrender.com/admin/notebook/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const handleDeleteMessage = async (id) => {
    ...
    const res = await fetch(`https://vibestudy-backend-avmi.onrender.com/admin/message/${id}`, {
      method: "DELETE",
      headers: { Authorization: `Bearer ${token}` },
    });
