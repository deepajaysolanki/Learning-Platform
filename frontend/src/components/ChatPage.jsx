...
export default function ChatPage() {
  ...
  useEffect(() => {
    const fetchFullNotebook = async () => {
      try {
        const response = await fetch(`https://vibestudy-backend-avmi.onrender.com/notebook/${id}`);
  ...
  const handleChatSubmit = async (userText) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://vibestudy-backend-avmi.onrender.com/notebook/${notebookId}/chat`,
        {
          method: "POST",
          headers: {
  ...
  const handleVideoSearch = async (userText = null) => {
    ...
    try {
      ...
      const response = await fetch("https://vibestudy-backend-avmi.onrender.com/get-videos", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
